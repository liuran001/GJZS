Configuration=2021100101
Magisk_Warehouse_version=2021091203
App_Store_version=2021091203
...
Install_Applet)
    name=Applet
    versionCode=79
    Install_Applet2 -file "Other/Applet/Applet-79.zip" "$name.zip" 8062768 b821e54c57419aeaa5da4b03f218d9fe "$name" $versionCode
;;
