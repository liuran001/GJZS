...
class AboutActivity : AbsAboutActivity() {
    ...
    override fun onItemsCreated(items: MutableList<Any>) {
        ...
        items.add(Card("QQ Group (QQ群):\n471041284"))
        items.add(Card("Mail:\nsupport@gjzsr.com"))
        items.add(Category("Developers"))
        items.add(Contributor(R.drawable.avatar_developer, "笨蛋ovo (@liuran001)", "Developer", "https://bdovo.cc"))
        items.add(Contributor(R.drawable.avatar_qqlittleice233, "QQ little ice", "Contributor", "https://github.com/qqlittleice233"))
        items.add(Contributor(R.drawable.avatar_qwq233, "James Clef", "Contributor", "https://qwq2333.top"))
        items.add(Contributor(R.drawable.avatar_original_developer, "情非得已c", "Original Developer", "https://obdo.cc/ZxZ3T2"))
        items.add(Contributor(R.drawable.avatar_icon_designer, "莫白の", "Icon Designer", "https://obdo.cc/RhtXwJ"))
