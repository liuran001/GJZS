...
class SplashActivity : Activity() {
    ...
    private fun checkPermissions() {
        ...
        checkRoot(Runnable {
            start_state_text.text = getString(R.string.GJZS_permission_checking)
            hasRoot = true
    ...
    private fun gotoHome() {
        if (this.intent != null && this.intent.hasExtra("JumpActionPage") && this.intent.getBooleanExtra("JumpActionPage", false)) {
            val actionPage = Intent(this.applicationContext, gjzs.online.ActionPage::class.java)
        ...
        override fun run() {
            try {
                ...
                if (process != null) {
                    ...
                    ScriptEnvironmen.executeShell(context, outputStream, config.beforeStartSh, params, null, "GJZS-splash")
